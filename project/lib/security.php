...
function securityCheck($path_parts, $yourURL, $form = false) {
    ...
    $whiteListPages[] = "example.php";
    $whiteListPages[] = "index.php";
    $whiteListPages[] = "form.php";
    $whiteListPages[] = "q01.php";
    $whiteListPages[] = "Trainer.php";
    $whiteListPages[] = "addTrainer.php";

    //add all the folders to this array
    $whiteListFolders = array();
    $whiteListFolders[] = "/cs148develop/pokemon/project";
    
    $whiteListFolders[] = "/education/cs148develop/pokemon/project";
    $whiteListFolders[] = "/develop/cs148develop/pokemon/project";
